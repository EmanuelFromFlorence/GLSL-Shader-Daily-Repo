...
void main(){
    ...
    vec2 v0 = 0.5 * cos(0.25 * u_time + vec2(0., 0.0) + 1.0);
    vec2 v1 = 0.5 * cos(0.55 * u_time + vec2(0., 1.0) + 2.0);
    vec2 v2 = 0.5 * cos(0.95 * u_time + vec2(1.0, 0.0) + 3.0);
    vec2 v3 = 0.5 * cos(0.55 * u_time + vec2(1.0, 1.0) + 4.0);
    vec2 v4 = 0.5 * cos(0.65 * u_time + vec2(1.5, 0.0) + 1.0);
    vec2 v5 = 0.5 * cos(0.75 * u_time + vec2(1.5, 2.5) + 2.0);
    vec2 v6 = 0.5 * cos(0.85 * u_time + vec2(3.0, 0.0) + 3.0);
    vec2 v7 = 0.5 * cos(0.95 * u_time + vec2(3.0, 2.5) + 1.0);
    vec2 v8 = 0.5 * cos(1.25 * u_time + vec2(0., 3.5) + 2.0);
